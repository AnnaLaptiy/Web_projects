...
function reset() {
    ...
    // <em class="recodPartiiWhite">
    // белые: a1, a3, b2, c1, c3, d2, e1, e3, f2, g1, g3, h2 </em><em class="scaleW">(12)</em><br>
    // <em class="recodPartiiBlack">
    // черные: a7, b6, b8, c7, d6, d8, e7, f6, f8, g7, h6, h8 </em><em class="scaleB">(12)</em><br>
    // <em class="r"> ход белых</em>
...
function changeData(indexOfBoardPiece, modifiedIndex, removePiece) {
    ...
    if (selectedPiece.pieceId <= 11&&document.getElementById("myList").getElementsByTagName("li").length>=1) {
        ...
        document.getElementById("myList").getElementsByTagName("li")[document.getElementById("myList").getElementsByTagName("li").length-1].innerHTML= document.getElementById("myList").getElementsByTagName("li")[document.getElementById("myList").getElementsByTagName("li").length-1].innerHTML+"    ход черных "+textnode11+textnode211

    } else if(selectedPiece.pieceId <= 11){
        cl = "recodPartiiWhite";
        const textnode1 = document.createTextNode("ход черных  ");
  ...
  //  }
    ...
    document.getElementById("myList").appendChild(node);
        ...
        cl = "recodPartiiWhite";
        const textnode1 = document.createTextNode("ход белых  ");
...
async function makeMove(number) {
    ...
    if (turn) {
        if (selectedPiece.isKing) {
            // document.getElementsByClassName("recodPartiiWhite")[0].innerHTML=document.getElementsByClassName("recodPartiiWhite")[0].innerHTML.replace(map1.get(board.indexOf(selectedPiece.pieceId)),map1.get(board.indexOf(selectedPiece.pieceId))+'(дамка)');
            // document.getElementsByClassName("recodPartiiWhite")[0].innerHTML = document.getElementsByClassName("recodPartiiWhite")[0].innerHTML.replace(map1.get(board.indexOf(selectedPiece.pieceId) + 1), map1.get(board.indexOf(selectedPiece.pieceId) + 1) + '(дамка)');
            // document.getElementsByClassName("recodPartiiBlack")[0].innerHTML = document.getElementsByClassName("recodPartiiBlack")[0].innerHTML.replace(map1.get(board.indexOf(selectedPiece.pieceId) + 1), map1.get(board.indexOf(selectedPiece.pieceId) + 1) + '(дамка)');
    ...
    if (window.confirm("Завершить ход / Отменить ход")) {
        ...
        if (turn) {
            if (selectedPiece.isKing) {
                ...
                // document.getElementsByClassName("recodPartiiBlack")[0].innerHTML=document.getElementsByClassName("recodPartiiBlack")[0].innerHTML.replace(map1.get(board.indexOf(selectedPiece.pieceId)),map1.get(board.indexOf(selectedPiece.pieceId))+'(дамка)');
...
function addKingToRecord() {
    ...
    for (var el = 0; el < document.getElementsByClassName("black-piece king").length; el++) {
        ...
        // document.getElementsByClassName("recodPartiiWhite")[0].innerHTML=document.getElementsByClassName("recodPartiiWhite")[0].innerHTML.replace(map1.get(board.indexOf(document.getElementsByClassName("black-piece king")[el].id)+1),map1.get(board.indexOf(selectedPiece.pieceId)+1)+'(дамка)');
        // document.getElementsByClassName("recodPartiiBlack")[0].innerHTML=document.getElementsByClassName("recodPartiiBlack")[0].innerHTML.replace(map1.get(board.indexOf(selectedPiece.pieceId)+1),map1.get(board.indexOf(selectedPiece.pieceId)+1)+'(дамка)');
